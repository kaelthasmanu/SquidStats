...
def index():
    ...
    try:
        ...
        return render_template(
            'index.html',
            grouped_connections=grouped_connections , page_title='Inicio Dashboard')
...
def cache_stats():
    ...
    try:
        ...
        return render_template('cacheView.html', cache_stats=stats_data, page_title='Estadísticas')
...
def logs():
    try:
        ...
        return render_template('logsView.html', users_data=users_data, page_title='Actividad usuarios')
    except Exception as e:
...
def reports():
    ...
    return render_template('reports.html', metrics=metrics, page_title='Reportes y gráficas')
