...
class SquidConfigSplitter:
    def __init__(self, input_file: str = None, output_dir: str = None, strict: bool = False):
    ...
    def _compile_rules(self) -> list[Rule]:
        ...
        return [
            ...
            Rule("40_refresh_patterns.conf", [
                re.compile(r"^refresh_pattern\b"),
            ]),
            Rule("50_ssl_bump.conf", [
                re.compile(r"^ssl_"),
    ...
    def _generate_main_config(self, generated_files: list[str]) -> None:
        ...
        try:
            ...
            logger.info(f"Main configuration file regenerated with {len(includes)} includes")
        except Exception as e:
