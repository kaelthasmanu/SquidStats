...
from database.database import Base, get_session, User, Log, LogMetadata, get_engine, table_exists, get_dynamic_table_names, get_dynamic_models
...
def process_logs(log_file):
    ...
    try:
        ...
        # Obtener modelos dinámicos para la fecha actual
        ...
        with DatabaseManager() as session:
            ...
            def commit_batch():
                ...
                retry_count = 0
                # Obtener nombres de tablas dinámicas
                user_table, log_table = get_dynamic_table_names()
                logger.info(f"Guardando usuarios en la tabla: {user_table}, logs en la tabla: {log_table}")
                # Usar los modelos dinámicos ya obtenidos
